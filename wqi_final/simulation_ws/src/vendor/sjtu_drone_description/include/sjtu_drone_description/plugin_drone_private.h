...
public:
  ...
  double landing_velocity_ = 0.35;
  std::atomic<double> landing_height_{0.0};
  double landing_tolerance_ = 0.04;
...
private:
  ...
  rclcpp::Subscription<std_msgs::msg::Float64>::SharedPtr landing_height_subscriber_{nullptr};
